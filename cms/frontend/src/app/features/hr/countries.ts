/** Common nationality / country list (English short names). Sorted alphabetically. */
export const COUNTRIES: string[] = [
  ...
  'Mozambican', 'Namibian', 'Nauruan', 'Nepalese', 'New Zealander', 'Ni-Vanuatu', 'Nicaraguan', 'Nigerian',
