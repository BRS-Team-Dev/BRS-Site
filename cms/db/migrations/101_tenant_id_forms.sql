...
ALTER TABLE `forms`                 ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `form_sections`         ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `form_fields`           ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `form_contact_us`       ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `form_newsletter_signup` ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `form_test`             ADD COLUMN `tenant_id` INT UNSIGNED NULL;
