...
-- ── admin / settings ─────────────────────────────────────────────
ALTER TABLE `admin_users`   ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `admin_sections` ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `settings`      ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `password_resets` ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
-- ── leads cluster ────────────────────────────────────────────────
ALTER TABLE `leads`              ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `lead_contacts`      ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `lead_contact_numbers` ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `lead_notes`         ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `lead_info`          ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `lead_documents`     ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
-- ── clients cluster ──────────────────────────────────────────────
ALTER TABLE `clients`            ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `client_contacts`    ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `client_contact_numbers` ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `client_accounts`    ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `client_notes`       ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `client_info`        ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `client_documents`   ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `client_service_offerings` ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `service_offerings`  ADD COLUMN `tenant_id` INT UNSIGNED NULL;
...
ALTER TABLE `onboarding_clients` ADD COLUMN `tenant_id` INT UNSIGNED NULL;
